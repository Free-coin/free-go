...
import (
	...
	"github.com/freecoin/free-go/cmd/utils"
	"github.com/freecoin/free-go/common"
	"github.com/freecoin/free-go/console"
	"github.com/freecoin/free-go/contracts/ens"
	"github.com/freecoin/free-go/crypto"
	"github.com/freecoin/free-go/ethclient"
	"github.com/freecoin/free-go/internal/debug"
	...
	"github.com/freecoin/free-go/rpc"
	"github.com/freecoin/free-go/swarm"
	bzzapi "github.com/freecoin/free-go/swarm/api"
...
func init() {
	...
	app.Copyright = "Copyright 2013-2016 The free-go Authors"
...
Export a local chunk database as a tar archive (use - to send to stdout).
    ...
    swarm db export ~/.freecoin/swarm/bzz-KEY/chunks chunks.tar

The export may be quite large, consider piping the output through the Unix
pv(1) tool to get a progress bar:

    swarm db export ~/.freecoin/swarm/bzz-KEY/chunks - | pv > chunks.tar
`,
				},
				{
					Action:    dbImport,
...
Import chunks from a tar archive into a local chunk database (use - to read from stdin).
    ...
    swarm db import ~/.freecoin/swarm/bzz-KEY/chunks chunks.tar

The import may be quite large, consider piping the input through the Unix
pv(1) tool to get a progress bar:

    pv chunks.tar | swarm db import ~/.freecoin/swarm/bzz-KEY/chunks -
`,
				},
				{
					Action:    dbClean,
