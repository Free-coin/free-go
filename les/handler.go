...
import (
	...
	"github.com/freecoin/free-go/trie"
)
...
// NewProtocolManager returns a new freecoin sub protocol manager. The Ethereum sub protocol manages peers capable
// with the freecoin network.
