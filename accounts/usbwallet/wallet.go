...
import (
	...
	freecoin "github.com/freecoin/free-go"
...
type wallet struct {
	...
	deriveChain    freecoin.ChainStateReader // Blockchain state reader to discover used account with
...
func (w *wallet) SelfDerive(base accounts.DerivationPath, chain freecoin.ChainStateReader) {
	w.stateLock.Lock()
	defer w.stateLock.Unlock()
