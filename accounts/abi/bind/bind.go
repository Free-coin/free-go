...
//
// Detailed usage document and tutorial available on the free-go Wiki page:
// https://github.com/freecoin/free-go/wiki/Native-DApps:-Go-bindings-to-Ethereum-contracts
package bind
